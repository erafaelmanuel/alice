...
public interface FormulaDao {
    ...
    Formula getFormulaBySubjectAndTeacherId(long subjectId, long teacherId) throws GradingFactorException;
    ...
    Formula updateFormulaById(long id, Formula newFormula, long subjectId, long teacherId) throws GradingFactorException;
