...
public class TimeHelperBean {
    ...
    public TimeHelperBean addHour(int hour) {
        time.setHour((time.getHour() + hour) % 24);
        return this;
    }

    public TimeHelperBean addMinute(int minute) {
    ...
    public TimeHelperBean addSecond(int second) {
    ...
    public TimeHelperBean convert(String stringDate) {
        try {
            String pattern[] = {
